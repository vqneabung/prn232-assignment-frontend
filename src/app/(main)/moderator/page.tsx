      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">2 verified today</p>
          </CardContent>
        </Card>
        ...
        <CardContent className="space-y-4">
          <div className="flex items-start space-x-3 border-b pb-3">
            ...
            <div className="flex-1">
              <p className="font-medium text-sm">High similarity detected</p>
              <p className="text-xs text-muted-foreground">Student #2024001, Assignment 1</p>
          ...
          <div className="flex items-start space-x-3 border-b pb-3">
            ...
            <div className="flex-1">
              <p className="font-medium text-sm">Complaint filed</p>
              <p className="text-xs text-muted-foreground">Student grade dispute</p>
          ...
          <div className="flex items-start space-x-3">
            ...
            <div className="flex-1">
              <p className="font-medium text-sm">Violation resolved</p>
              <p className="text-xs text-muted-foreground">Student #2024005 verified 0-point</p>
